<script>
  ...
  let selectedChapter=$derived(chapters.find(chapters => chapters.number === selectedChapterNumber));
  //class:selected-chapter-title={selectedChapterNumber === chapter.number} check if the selectedChapterNumber is the same  chapter.numbe, apply the class selected-chapter-title
